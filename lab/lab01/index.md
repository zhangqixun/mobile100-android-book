...
下载后，双击下载完成的安装包，进行安装，点击“Next”继续，继续点击“Next”继续，点击“I Agree”继续安装。截图是以下三张。
...
，打开主界面，依次选择「Tools」、「Options...」，弹出『Android SDK Manager - Settings』窗口，对话框如下图所示。
![](D61.png)
...
Android studio的快捷键是非常重要的，在实际开发中运用快捷键加快代码的编写速度